...
import com.chetan.kotlin.common.makeToast
...
class NoteListView : Fragment(), INoteListContract.View {
    ...
    override fun startLoginFeature() = com.chetan.kotlin.common.startLoginFeature(this.activity)

    override fun startNoteDetailFeatureWithExtras(noteId: String, isPrivate: Boolean) = com.chetan.kotlin.common.startNoteDetailFeatureWithExtras(this.activity, noteId, isPrivate)
